...
TEST(async, input1) {
  {
    ...
    EXPECT_EQ(file_contents("bulk10000.log")+file_contents("bulk10001.log"), file_contents("testoutput1.txt"));
  }
}
...
TEST(async, input2) {
  {
    ...
    EXPECT_EQ(
      file_contents("bulk20000.log")+file_contents("bulk20001.log")+file_contents("bulk20002.log"),
...
TEST(async, input_mix) {
  {
    ...
    std::filesystem::remove("bulk30000.log");
    std::filesystem::remove("bulk40000.log");
    std::filesystem::remove("bulk50000.log");
    std::filesystem::remove("bulk50000-001.log");
    std::filesystem::remove("bulk30001.log");
    std::filesystem::remove("bulk40001.log");
    ...
    EXPECT_EQ(file_contents("bulk30000.log"    ), "bulk: h1.str1, h1.str2, h1.str3\n");
    EXPECT_EQ(file_contents("bulk30001.log"    ), "bulk: h1.str4, h1.str5\n"         );
    EXPECT_EQ(file_contents("bulk40000.log"    ), "bulk: h2.str1, h2.str2, h2.str3\n");
    EXPECT_EQ(file_contents("bulk40001.log"    ), "bulk: h2.str4, h2.str5\n"         );
    EXPECT_EQ(file_contents("bulk50000.log"    ), "bulk: h3.str1, h3.str2, h3.str3\n");
    EXPECT_EQ(file_contents("bulk50000-001.log"), "bulk: h3.str4, h3.str5\n"         );
  }
}
